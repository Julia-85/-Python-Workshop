...
poem = str(input('Введите фразу стихотворения: '))
vowels = str('уеёаоэяыию')

let = [len([i for i in el if i.lower() in vowels]) for el in poem.split()]
if all([i == let[0] for i in let]):
  print('Парам пам-пам')
else:
   print('Пам парам')
